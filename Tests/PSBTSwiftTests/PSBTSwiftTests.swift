...
//            XCTAssertEqual("304302200424b58effaaa694e1559ea5c93bbfd4a89064224055cdf070b6771469442d07021f5c8eb0fea6516d60b8acb33ad64ede60e8785bfb3aa94b99bdf86151db9a9a01", psbt.psbtInputs[0].partialSignatures.values.first?.toHexString())
    ...
    func testvalidSignerTwoInputsTwoOutputsExample() throws {
        do {
            let string = ""
            let psbt = try PSBT.fromString(strPSBT: string)
//            XCTAssertEqual("3044022065f45ba5998b59a27ffe1a7bed016af1f1f90d54b3aa8f7450aa5f56a25103bd02207f724703ad1edb96680b284b56d4ffcb88f7fb759eabbe08aa30f29b851383d201", psbt.psbtInputs[1].partialSignatures.values.first!.toHexString())
            debugPrint("saaa")
        } catch let error {
            debugPrint(error.localizedDescription)
        }
...
//            XCTAssertEqual("3044022062eb7a556107a7c73f45ac4ab5a1dddf6f7075fb1275969a7f383efff784bcb202200c05dbb7470dbf2f08557dd356c7325c1ed30913e996cd3840945db12228da5f01", Hex.toHexString(psbt1.getPsbtInputs().get(1).getPartialSignatures().values().iterator().next().encodeToBitcoin()));
